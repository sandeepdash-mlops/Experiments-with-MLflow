...
with mlflow.start_run() as parent:
    ...
    # Log training and Evaluation data using MLflow if autolog is not enabled
    # Log training data
    train_df = X_train.copy()
    train_df['target'] = y_train

    # mlflow itself a dataclass mlflow.data.from_pandas, need to convert this a object
    ...
    # Set tags
    mlflow.set_tag("author", "Sandeep Dash")
