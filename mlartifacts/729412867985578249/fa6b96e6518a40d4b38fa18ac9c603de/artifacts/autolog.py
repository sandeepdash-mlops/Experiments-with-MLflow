...
mlflow.autolog()  # To enable autolog
...
with mlflow.start_run():
    ...
    # for file it doesn't log automatically, need to mention explicitely to log this script.
    mlflow.log_artifact(__file__)

    # Tags also doesn't tag automatically as it need manual inputs.
